...
from few_shot.datasets import OmniglotDataset, MiniImageNet,SETA,AWF,DF,DC
...
if __name__ == '__main__':
	...
	print("matching_nets.py is reconfiguring for your requested experimental settings: number of epochs, input record size, training episodes for dataset", args.dataset)
	if args.dataset == 'omniglot':
		# Sorry, but omniglot and miniimagenet won't work while the model is configured for 1D convolutions
		n_epochs = 100
		dataset_class = OmniglotDataset
		num_input_channels = 1
		lstm_input_size = 64
		print("Training for epochs:", n_epochs)        
	...
	elif args.dataset == 'AWF':
       
		n_epochs = 2
		dataset_class = AWF
		num_input_channels = 1
		lstm_input_size = 5000
		print("Training for epochs:", n_epochs, "\nEvaluation episodes:", evaluation_episodes, "\nEpisodes per epoch:", episodes_per_epoch)
